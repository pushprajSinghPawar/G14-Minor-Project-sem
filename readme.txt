letsblog
A blogging system built using Django framework. It is designed for interactions between bloggers and readers.
...
then create a virtual environment for the dkango modules :
