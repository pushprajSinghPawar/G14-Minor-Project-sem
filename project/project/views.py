                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <!-- <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                                <li><a class="dropdown-item" href="/blog/postoftheday">post of the day</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="/blog/topbloggers">our top bloggers</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                            </ul>
    ...
    <div class="out-box-redirectpage" style="width: 100vw; background-color: yellow;">
        <div style="width: max-content; height: 70vh; background-color: aqua; margin:auto; font-size:10vh;" >
            ...
            <br>
                ...
                <a class="nav-link" href="/blog">enter as reader</a>
        </div>
    </div>
    <br>
    <br>
